const e="usability-testing",t="Unmoderated Usability Testing",o="2 days",s="25 Participants",n="low",a=`Just like moderated usability testing, unmoderated testing gives you the ability to test your prototypes with 25 people to seek feedback and still maintain the rich insights that you get in a moderated usability testing session. 
...
It's important to know that it takes a bit more time to set these up, but the insights you gain from this type of testing are invaluable. 
 ...
 - It merges the qualitative insights of a moderated session and combines them with a large sample size. `,i=[{name:"Askable",description:"Recruitment & Moderation",icon:"fa-users",logo:"/assets/logos/askable.svg",link:"https://app.askable.com/studies"},{name:"Figma Slides",description:"Insights Presentation",icon:"fa-presentation",logo:"/assets/logos/figma.svg",link:"https://www.figma.com/slides/RodMmoG77vJztZsM6Z3Ean/2025-Research-Playback?node-id=0-1&t=nlOtgNcANnRzEIU2-1"},{name:"Figjam",description:"User Testing Notes",icon:"fa-sticky-note",logo:"/assets/logos/figma.svg",link:"https://www.figma.com/board/fqIVeexVfMkLLeFw0kezPF/2025-Usability-testing---Project-repository?node-id=3-2633&t=IILy0onEhyPwDd8l-1"}],r=[{filename:"00-screen-goals.png",caption:"Define screen goals and user objectives"},{filename:"01-Add-your-screens.png",caption:"Add your screens to the testing flow"},{filename:"02-Creating-your-scenario.png",caption:"Create realistic user scenarios"},{filename:"03-Setting-Up-askable.png",caption:"Set up your study on Askable platform"},{filename:"04-JoiningSessions.png",caption:"Join and facilitate testing sessions"},{filename:"05-DocumentFeelings.png",caption:"Document user feelings and emotions"},{filename:"05-questions-to-ask.png",caption:"Key questions to ask during sessions"},{filename:"06-final-product.png",caption:"Final product presentation"},{filename:"06-final-product2.png",caption:"Additional final product views"},{filename:"07-DocumentInsights.png",caption:"Document insights and findings"}],h=[{title:"Screen Goals",description:`Screen Goals are probably one of the most important parts of the process. They set you and your test up for success by allowing you to really think through what you are trying to learn on each of the screens. 
...
Things not to do: 
 - Don't write them in a technical way that takes time to process the real meaning `,screenshot:"00-screen-goals.png"},{title:"Add Your Screens",description:`Using Figjam, (in link above) your job at this step is to add one screenshot for every screen that you are testing, which should correlate to your screen goals. Every screen you add has a screen goal, and every screen goal has a screenshot of that screen so that people documenting feedback can note down the feedback. 
...
`,screenshot:"01-Add-your-screens.png"},{title:"Create Your Scenarios",description:`To write a good scenario, first and foremost, you need to make sure that you have written your screen goals. You will need to know what you are testing before you can write these scenarios because they determine how you create your scenarios.
...
With this example, even though you might have a screen goal and you are trying to test the payment flow, asking a leading question like the example above can skew the result.`,screenshot:"02-Creating-your-scenario.png"},{title:"Set Up Askable Study",description:`1. I have created some templates for you to duplicate for your studies, for user testing, this one will be the first one in the list. 
...
Considerations
 ...
 - `,screenshot:"",screenshots:["Screenshot 2025-08-13 at 9.47.07am-1755042443037-200082741.png","Screenshot 2025-08-13 at 9.48.18am-1755042500428-449990320.png"]},{title:"Set up your prototype questions",description:`In the template, I have set up an example first question and second question to get you started. You will need to start of by creating and uploading a link to your figma prototype and attaching it to the first option with the blue icon. You will see in the screenshot what it should look like. 

Each task/ scenario that you add will be considered as a block, which means that this blue example that I have created will be considered your first task that you give to users.`,screenshot:"",screenshots:["Screenshot 2025-08-13 at 9.35.19am-1755041721590-536165667.png"]},{title:"Adding another block",description:`You have a few options, but the key one for an unmoderated test you will use is the top one "Prototype test" and the "Open Answer" or the "Multiple Choice" 
...
You can see in the not so good insight.`,screenshot:"07-DocumentInsights.png"}],l={slug:e,title:t,duration:o,participants:s,complexity:n,purpose:a,tools:i,screenshots:r,steps:h};export{n as complexity,l as default,o as duration,s as participants,a as purpose,r as screenshots,e as slug,h as steps,t as title,i as tools};
